        ...
        <div id="spreadsheet" class="spreadsheet">
            <div class="all">
                <main>
                    ...
                    <div id="boxValues" class="spreadsheet-values" style="display: none;">
                ...
                <div class="buttons">
                    ...
                    <div class="buttons-print">
                        <input type="button" class="btn btn-secondary shadow" value="Imprimir" name="print" id="print" onclick="printTable()">
                    </div>         
            </div>   
            </div>
        </div>
